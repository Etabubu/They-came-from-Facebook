...
package com.gogogic.dragmanager.events
{
	...
	public class DragEvent extends MouseEvent
	{
		 ...
		 *
		 *  @param dragInitiator DisplayObject that specifies the component initiating
		 *  the drag.
		 *
		...
		override public function clone():Event
		{
			...
			cloneEvent.wasCancelled = this.wasCancelled;
